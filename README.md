...
1. `StarsandIsland_KoreanPatch_2026-04-10_v1.0.6.zip`을 다운로드합니다.
2. 압축을 원하는 위치에 풉니다.
...
- `v1.0.6`은 GUI 런처 구조를 유지하면서, `2026.14.49.0` 원문 대응분을 추가 반영합니다.

## 이번 버전 주요 내용

- `2026.14.49.0` 원문 diff 반영
  - `added 0`
  - `removed 1`
  - `changed 1`
- semantic review 1행 반영
- 최신 인게임 inject JSON 재생성 반영
