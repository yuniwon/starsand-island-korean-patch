...
1. `StarsandIsland_KoreanPatch_2026-03-11_v1.0.2.zip`을 다운로드합니다.
2. 압축을 원하는 위치에 풉니다.
...
- `v1.0.2`는 `v1.0.1`의 설치 구조를 유지하면서, `2026.9.40.0` 원문 업데이트 대응분까지 포함합니다.
...
- 최신 게임 업데이트 원문 대응
- 추가/삭제/변경된 텍스트 재동기화
- 의미 변화가 있는 문장 수동 검토 반영
- 제작/재료 canonical 정리 유지
  - `방적기 / 직조기`
  - `연한 목재 / 단단한 목재`
  - `연한 목재 판자 / 단단한 목재 판자`
  - `광석 / 원단`
