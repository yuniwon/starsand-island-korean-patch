...
1. `StarsandIsland_KoreanPatch_2026-03-26_v1.0.3.zip`을 다운로드합니다.
2. 압축을 원하는 위치에 풉니다.
...
- `v1.0.3`는 `v1.0.2`의 설치 구조를 유지하면서, `2026.11.43.0` 원문 업데이트 대응분까지 포함합니다.
...
- 제작/재료 canonical 정리 유지
  ...
  - `연한 목재 판자 / 단단한 목재 판자`
  - `광석 / 원단`
- 최신 인게임 inject JSON 재생성 및 로컬 번들 재패치 기준 반영
